<?php
// session_start() deve ser sempre a primeira coisa no arquivo
session_start();

// =======================================================
// CORREÇÃO APLICADA AQUI
// Movendo o require_once para o topo do arquivo.
// Isso garante que a BASE_URL e a conexão $pdo estejam disponíveis sempre.
// =======================================================
...
if (isset($_SESSION['mensagem_sucesso'])) {
    ...
    // Apaga a mensagem da sessão para não mostrá-la novamente
    unset($_SESSION['mensagem_sucesso']);
}

// Lógica de processamento de login (só executa se o formulário for enviado)
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // A conexão já foi feita pelo require_once no topo
    ...
    try {
        ...
        if ($usuario && password_verify($senha, $usuario['senha_hash'])) {
            ...
            $_SESSION['mensagem_sucesso'] = "Login realizado com sucesso! Bem-vindo(a)!";
            // Redireciona usando a BASE_URL para garantir o caminho correto
...
<body>
    ...
    <?php 
        // Incluindo o cabeçalho público padrão
